...
public class  GetNCReceiptToReportByFile implements  InterfaceRpt
{
...
//	Mrecord ul;
	...
	public void getAllRequestedRp(String hcode,String yyyymm,String branch,String cont) throws Exception
	{
		ask = CFile.opens("ask"+yyyymm+"@cbranch");
		yyyymm = DateInfo.nextMonth(yyyymm).substring(0,6);
		if(CFile.isFileExist("ask"+yyyymm+"@cbranch"))
		{
...
//		ind = CFile.opens("indmast@mstpolicy");
	...
	boolean inNextAskyyyymm(String rpNo,String status)
	{
        ...
        public static void main(String args[]) throws Exception
        {
                ...
                GetNCReceiptToReportByFile ncrec = new GetNCReceiptToReportByFile();
