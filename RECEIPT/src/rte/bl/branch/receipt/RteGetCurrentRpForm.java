...
public class RteGetCurrentRpForm  implements Task
{
	...
	public Result execute(Object param)
	{
		...
		//				throw new Exception(M.stou("เอกสารทีบันทึกไม่อยู่ในสต๊อกเอกสารเครื่องพิมพ์ที่ ")+printer);	
					usedreceiptform.set("printer",rec.get("printer"));			
					usedreceiptform.set("printDate",printDate);
					usedreceiptform.set("deptCode",rec.get("deptCode"));
					usedreceiptform.set("docCode",rec.get("docCode"));		
					usedreceiptform.set("startNo",rec.get("startNo"));
