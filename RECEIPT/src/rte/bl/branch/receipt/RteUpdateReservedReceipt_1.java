...
import java.util.*;
public class RteUpdateReservedReceipt_1  implements Task
{
	public Result execute(Object param)
	{
		...
		sfname = sfname+month+"@cbranch";
		if (typeOfPol.charAt(0) == 'U')
			sfname = "ulrpserved"+month+"@universal";
		try {
			if(Masic.fileStatus(sfname) < 2)
			{
				sfname = typeOfPol.toLowerCase()+"rpserved";
