...
public class  RteCheckAnother implements  Task
{
	Mrecord ord;
        Mrecord whl;
	Mrecord ind;
	...
	public Result execute(Object param) 
		...
		try {
			...
			String [] field = {"policyNo","preName","firstName","lastName","idNo","branch","planNo","effectiveDate","matureDate","caseID","insolventDate","status","dataDate","sum"};
			int  [] len = {8,20,30,30,13,3,4,8,8,15,8,1,8,9};
			Rtemp trec = new Rtemp(field,len);
			vi.addElement(field);
			vi.addElement(len);
			System.out.println("in RteCheckAnother---- "+kf+"........."+selk+".........."+keySearch1);
	...
	private void  getInsolventTran(String policyNo,String caseID) throws Exception
		...
		System.out.println("bingo...............................getTran");
                ...
                {
			if(insolventtran.get("typeOfTran").charAt(0) == 'C')
				continue;
